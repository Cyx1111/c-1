<%@ Page Title="管理帐户" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Manage.aspx.vb" Inherits="$safeprojectname$.Manage" %>
        ...
        $endif$
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="删除" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "从你的帐户中删除此 " & Item(Of OpenAuthAccountData)().ProviderDisplayName & " 登录" %>'
                            Visible="<%# CanRemoveExternalLogins %>" />
                    </td>
                    $endif$
                </tr>
