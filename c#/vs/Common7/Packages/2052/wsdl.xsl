...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:ms="urn:schemas-microsoft-com:xslt" xmlns:s="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="wsdl ms s">
...
<xsl:template match="definitions">
    <xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="service">
                <xsl:for-each select="service">
                    ...
                    <h1 class="listpage" _locID="L_string01_Text">"<xsl:value-of select="@name"/>" 说明</h1>

                    <xsl:if test="documentation">
                        <h2 _locID="L_string02_Text">文档</h2>
                        <p>
                            <xsl:value-of select="."/>
                        </p>
            ...
            <xsl:otherwise>
                <xsl:if test="documentation">
                    <h1 class="listpage" _locID="L_string03_Text">说明</h1>
                    <h2 _locID="L_string12_Text">文档</h2>
                    <p>
                        <xsl:value-of select="."/>
                    </p>
        ...
        <xsl:choose>
            <xsl:when test="portType">
                ...
                <h2 _locID="L_string04_Text">方法</h2>
            ...
            <xsl:otherwise>
                <br/><p class="heading2" _locID="L_string05_Text">在此页上未找到任何端口或方法。</p>

                <p _locID="L_string06_Text">如果这是 ASP.NET Web 服务，请确保所有 WebMethods 都是公共的并且
			        具有 &lt;WebMethod&gt; 特性。
</p>
                <p _locID="L_string07_Text">Visual Basic 示例:</p>
                ...
                <p dir="ltr" _locID="L_string09_Text">Visual C# 示例:</p>
                <BLOCKQUOTE dir="ltr" style="MARGIN-RIGHT: 0px">
    ...
    <xsl:otherwise>
            <p class="heading2" _locID="L_string11_Text">在此页上未找到任何 Web 服务。</p>
    </xsl:otherwise>
    </xsl:choose>
</xsl:template>
