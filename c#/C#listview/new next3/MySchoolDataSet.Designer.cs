...
namespace new_next3 {
    ...
    public partial class MySchoolDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentRow AddStudentRow(int StudentNo, string LoginPwd, string StudentName, string Sex, int GradeId, string Phone, string Address, System.DateTime BornDate, string Email) {
...
namespace new_next3.MySchoolDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([StudentNo] = @Original_StudentNo) AND ([LoginPwd] = @Original_LoginPwd) AND ([StudentName] = @Original_StudentName) AND ([Sex] = @Original_Sex) AND ([GradeId] = @Original_GradeId) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ([BornDate] = @Original_BornDate) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([StudentNo], [LoginPwd], [StudentName], [Sex], [GradeId], [Phone], [Address], [BornDate], [Email]) VALUES (@StudentNo, @LoginPwd, @StudentName, @Sex, @GradeId, @Phone, @Address, @BornDate, @Email);
SELECT StudentNo, LoginPwd, StudentName, Sex, GradeId, Phone, Address, BornDate, Email FROM Student WHERE (StudentNo = @StudentNo)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [StudentNo] = @StudentNo, [LoginPwd] = @LoginPwd, [StudentName] = @StudentName, [Sex] = @Sex, [GradeId] = @GradeId, [Phone] = @Phone, [Address] = @Address, [BornDate] = @BornDate, [Email] = @Email WHERE (([StudentNo] = @Original_StudentNo) AND ([LoginPwd] = @Original_LoginPwd) AND ([StudentName] = @Original_StudentName) AND ([Sex] = @Original_Sex) AND ([GradeId] = @Original_GradeId) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ([BornDate] = @Original_BornDate) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT StudentNo, LoginPwd, StudentName, Sex, GradeId, Phone, Address, BornDate, Email FROM Student WHERE (StudentNo = @StudentNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::new_next3.Properties.Settings.Default.MySchoolConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentNo, LoginPwd, StudentName, Sex, GradeId, Phone, Address, BornDate, " +
        ...
        public virtual int Delete(int Original_StudentNo, string Original_LoginPwd, string Original_StudentName, string Original_Sex, int Original_GradeId, string Original_Phone, string Original_Address, System.DateTime Original_BornDate, string Original_Email) {
        ...
        public virtual int Insert(int StudentNo, string LoginPwd, string StudentName, string Sex, int GradeId, string Phone, string Address, System.DateTime BornDate, string Email) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_GradeId));
            if ((Original_Phone == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[18].Value = ((System.DateTime)(Original_BornDate));
            if ((Original_Email == null)) {
        ...
        public virtual int Update(
                    ...
                    System.DateTime Original_BornDate, 
                    string Original_Email) {
            return this.Update(Original_StudentNo, LoginPwd, StudentName, Sex, GradeId, Phone, Address, BornDate, Email, Original_StudentNo, Original_LoginPwd, Original_StudentName, Original_Sex, Original_GradeId, Original_Phone, Original_Address, Original_BornDate, Original_Email);
        }
    }
